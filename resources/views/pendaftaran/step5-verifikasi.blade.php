    ...
    <div class="container section">
        <div class="registration-container">
            ...
            <section class="reg-header" style="margin-bottom: 40px;">
                ...
                <p>Silakan verifikasi semua data yang Anda masukkan. Pastikan data sudah benar sebelum mengirim pengajuan.
                </p>
            </section>

            <div class="progress-bar-wrap">
                <div class="progress-step-list">
                    <a href="/pendaftaran/step1-data-diri" class="progress-step-item completed"
                        style="text-decoration:none;color:inherit;">
                        <div class="progress-step-circle"><span>✓</span></div>
                        <span class="progress-step-label">Data Diri</span>
                    </a>
                    <a href="/pendaftaran/step2" class="progress-step-item completed"
                        style="text-decoration:none;color:inherit;">
                        <div class="progress-step-circle"><span>✓</span></div>
                        <span class="progress-step-label">Akademik</span>
                    </a>
                    <a href="/pendaftaran/step3" class="progress-step-item completed"
                        style="text-decoration:none;color:inherit;">
                        <div class="progress-step-circle"><span>✓</span></div>
                        <span class="progress-step-label">Pilih Unit</span>
                    </a>
                    <a href="/pendaftaran/step4" class="progress-step-item completed"
                        style="text-decoration:none;color:inherit;">
                        <div class="progress-step-circle"><span>✓</span></div>
            ...
            <div class="form-card-kai">
                ...
                <div class="verification-leader">
                    ...
                    <p>Periksa kembali seluruh informasi, pilih unit magang tujuan, dan setiap pernyataan di bawah ini untuk
                        melanjutkan.</p>
                </div>
                ...
                <div class="form-section-kai">
                    ...
                    <div class="verification-item"
                        style="margin-top:16px;padding-top:16px;border-top:1px solid rgba(0,48,135,0.06);">
                ...
                <div class="form-section-kai">
                    ...
                    <div class="acknowledgement">
                        <div class="checkbox-group">
                            ...
                            <label for="confirm1">Saya menyatakan bahwa semua data yang saya isi adalah benar dan dapat
                                dipertanggungjawabkan.</label>
                        </div>
                        <div class="checkbox-group">
                            <input type="checkbox" id="confirm2">
                            <label for="confirm2">Saya bersedia mengikuti semua peraturan dan ketentuan program magang PT
                                Kereta Api Indonesia.</label>
                        </div>
                        <div class="checkbox-group">
                            <input type="checkbox" id="confirm3">
                            <label for="confirm3">Saya memberikan izin kepada PT KAI untuk menggunakan data saya untuk
                                keperluan proses rekrutmen magang.</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="data-security-box">
                    ...
                    <div class="security-content">
                        ...
                        <p>Informasi yang Anda berikan akan dirahasiakan dan hanya diproses oleh SDM PT KAI untuk keperluan
                            magang.</p>
                    </div>
                </div>

                <div class="form-actions-kai">
                    <a href="/pendaftaran/step4" class="btn-kai-secondary"
    ...
    <script>
        ...
        async function submitFinal() {
            ...
            try {
                ...
                // Langsung redirect ke success, hapus fetch kirim-email
